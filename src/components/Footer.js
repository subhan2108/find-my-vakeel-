    ...
    <footer className="text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm mb-6">
              India's most trusted legal marketplace. Connecting clients with verified advocates across 100+ cities.
            </p>
            <div className="flex gap-3">
              <a href="#" className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-brand-gold hover:text-brand-dark transition-all">
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-400 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span>123 Legal Chambers, High Court Road,<br />New Delhi, India - 110001</span>
              </li>
              <li className="flex items-center gap-3">
                <i className="fas fa-phone text-brand-gold"></i>
                <span>+91 82618 89815</span>
              </li>
              <li className="flex items-center gap-3">
                <i className="fas fa-envelope text-brand-gold"></i>
                <span>support@findmyvakeel.com</span>
              </li>
              <li className="pt-4">
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-500">
          <p>© 2024 Find My Vakeel. All rights reserved.</p>
